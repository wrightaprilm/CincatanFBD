...
\begin{figure*}
  \includegraphics[width=\textwidth]{figures/Pancakes over Time.pdf}

  \caption{A dated phylogeny of the Cinctans. Branch widths are proportional to the posterior probability of the branch, with wider branches reflecting higher posterior probability. \textbf{Pete, fill in some other meanings here?}}
\end{figure*}
