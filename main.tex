...
Of course, innumerable paleobiological studies indicate that origination, extinction and sampling all vary over time within clades (see., e.g., our Figure 3).  Shifts in these rates means that the prior probability of a branch spanning 1 million years is not constant throughout clade history \citep{Wagner2019}. % Pete to others: I figured that some background explaining why this is important might help: sorry to blow my own horn!
